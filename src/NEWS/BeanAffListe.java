...
public class BeanAffListe
{
	...
	public void connect()
	{
		...
		{
			erreur += "Probleme d'acces � la base de donn�e" + e.toString();
		}
		catch (Exception e)
		{
	...
	public void nextElement()
	{
		try
		{
			// r�cup�ration des donn�es du formulaire en cours
	...
	// setters
	/** d�finition du theme a rechercher */
	public void setReftheme(String pol)
	{
		reftheme = pol;
	}
	/** d�finition de la formation a rechercher */
	...
	// getters
	/** r�cup�ration du theme a rechercher */
	public String getReftheme()
	{
		return reftheme;
	}
	/** r�cup�ration de la formation a rechercher */
	...
	{
		String liste = "";
		boolean newsExiste = false; // il existe au moins une news ? on initialise � faux
	...
	private static class Outils {
		public static String redate(Date date) {
			return null;
		}
	}
}
