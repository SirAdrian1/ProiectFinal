...
public class BeanAffNews
{
	...
	public void connect()
	{
		...
		{
			erreur += "Probleme d'acces la base de donne" + e.toString();
		}
		catch (Exception e)
		{
	...
	{
		return Outils.redate();
	}
	public String getCorps()
	{
		return Outils.prepareAffichage(corps);
	}
	...
	// setters
	/** definition de la news a rechercher */
	...
	private static class Outils {
		...
		public static String prepareAffichage(String corps) {
			return corps;
		}
