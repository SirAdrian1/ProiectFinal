...
import java.io.*;
import java.sql.*;
public class msh extends HttpServlet
{
	...
	try
	{
		...
		String alph=req.getParameter("msrh");
		String qry="select title,artist1,artist2,s1,s2,rate from music where title = '"+alph+"' ";
		rs=stmt.executeQuery(qry);
		pw.println("<center><u>"+"<font size=5><b>"+"MOVIE "+alph.toUpperCase() +"</b></u></center></font>");
...
finally
{
	...
	private class HttpServletRequest {
		public String getParameter(String msrh) {
			return null;
		}
	}
